...
delt <- cursp %>%
  group_by(Year) %>%
  summarise(
    csmaxM = max(Delma.MA, na.rm = TRUE),
    csminM = min(Delma.MA, na.rm = TRUE),
    csavM  = mean(Delma.MA, na.rm = TRUE),
    cssdM  = sd(Delma.MA, na.rm = TRUE)
  )

ras <- cursp %>%
  group_by(Year) %>%
  summarise(
    csmaxM = max(RasGhanada.MA, na.rm = TRUE),
    csminM = min(RasGhanada.MA, na.rm = TRUE),
    csavM  = mean(RasGhanada.MA, na.rm = TRUE),
    cssdM  = sd(RasGhanada.MA, na.rm = TRUE)
  )

saa <- cursp %>%
  group_by(Year) %>%
  summarise(
    csmaxM = max(Saadiyat.MA, na.rm = TRUE),
    csminM = min(Saadiyat.MA, na.rm = TRUE),
    csavM  = mean(Saadiyat.MA, na.rm = TRUE),
    cssdM  = sd(Saadiyat.MA, na.rm = TRUE)
  )

ala <- cursp %>%
  group_by(Year) %>%
  summarise(
    csmaxM = max(AlAqah.MA, na.rm = TRUE),
    csminM = min(AlAqah.MA, na.rm = TRUE),
    csavM  = mean(AlAqah.MA, na.rm = TRUE),
    cssdM  = sd(AlAqah.MA, na.rm = TRUE)
  )

dib <- cursp %>%
  group_by(Year) %>%
  summarise(
    csmaxM = max(Dibba.MA, na.rm = TRUE),
    csminM = min(Dibba.MA, na.rm = TRUE),
    csavM  = mean(Dibba.MA, na.rm = TRUE),
    cssdM  = sd(Dibba.MA, na.rm = TRUE)
  )
