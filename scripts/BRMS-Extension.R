...
{\*\expandedcolortbl;;}
\paperw11900\paperh16840\margl1440\margr1440\vieww12760\viewh12000\viewkind0
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0

\f0\fs24 \cf0 # Packages required\
req_pkgs <- c(\
...
## each gulf\'92s observed range (no extrapolation) and interaction terms: how those slopes differ between gulfs.\
\
...
r2_bayes(ex_mbrms3dwHW_1full)\
r2_bayes(ex_mbrms3dwHW_1fullgamma)\
pp_check(ex_mbrms3dwHW_1full)\
pp_check(ex_mbrms3dwHW_1fullgamma)\
\
loo(ex_mbrms3dwHW_1full, ex_mbrms3dwHW_1fullgamma, cores = getOption("mc.cores", 1))\
\
\
\
#### Going from here\
\
ex_mbrms3dwHW_1full_1 <- brms::brm(extension~ StavR_centered+WtavR_centered+ WtsdR+ winSlope+ StsdR+ sumSlope+ WcsavR+ gulf+ Bheight+StavR_centered:Bheight+WtavR_centered:Bheight+ \
                                   winSlope:Bheight+ StsdR:Bheight+ sumSlope:Bheight+StavR_centered:gulf+WtavR_centered:gulf+ WtsdR:gulf+ \
                                   winSlope:gulf+ StsdR:gulf+ sumSlope:gulf+ WcsavR:gulf+ Bheight:gulf+(1 |colony/year),\
                                 data = testex, family = Gamma(link = "log"), chains = 3, control = list(adapt_delta = 0.95),\
                                 iter = 5000, warmup = 3000)\
\
ex_mbrms3dwHW_1full_2 <- brms::brm(extension~ StavR_centered+WtavR_centered+ WtsdR+ winSlope+ StsdR+ sumSlope+ WcsavR+ gulf+ Bheight+StavR_centered:Bheight+WtavR_centered:Bheight+ \
                                     winSlope:Bheight+ StsdR:Bheight+ sumSlope:Bheight+StavR_centered:gulf+WtavR_centered:gulf+ WtsdR:gulf+ \
                                     winSlope:gulf+ StsdR:gulf+ sumSlope:gulf+ WcsavR:gulf+ Bheight:gulf+(1 |colony),\
                                   data = testex, family = Gamma(link = "log"), chains = 3, control = list(adapt_delta = 0.95),\
                                   iter = 5000, warmup = 3000)\
\
ex_mbrms3dwHW_1full_3 <- brms::brm(extension~ StavR_centered+WtavR_centered+ WtsdR+ winSlope+ StsdR+ sumSlope+ WcsavR+ gulf+ Bheight+StavR_centered:Bheight+WtavR_centered:Bheight+ \
                                     winSlope:Bheight+ StsdR:Bheight+ sumSlope:Bheight+StavR_centered:gulf+WtavR_centered:gulf+ WtsdR:gulf+ \
                                     winSlope:gulf+ StsdR:gulf+ sumSlope:gulf+ WcsavR:gulf+ Bheight:gulf+(1 + Bheight|colony),\
                                   data = testex, family = Gamma(link = "log"), chains = 3, control = list(adapt_delta = 0.95),\
                                   iter = 5000, warmup = 3000)\
\
loo(ex_mbrms3dwHW_1full, ex_mbrms3dwHW_1fullgamma, ex_mbrms3dwHW_1full_1, ex_mbrms3dwHW_1full_2, ex_mbrms3dwHW_1full_3, cores = getOption("mc.cores", 1))\
\
